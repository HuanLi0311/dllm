...
import iclr_1.SMDM.lit_gpt.model
from iclr_1.SMDM.lit_gpt.utils import find_multiple
...
class Config:
    ...
    def mlp_class(self) -> Type:
        ...
        return getattr(iclr_1.SMDM.lit_gpt.model, self._mlp_class)

    @property
    def norm_class(self) -> Type:
        # `self._norm_class` cannot be the type to keep the config json serializable
        if self._norm_class == "RMSNorm":
            from iclr_1.SMDM.lit_gpt.rmsnorm import RMSNorm

            return RMSNorm
        elif self._norm_class == "FusedRMSNorm":
            from iclr_1.SMDM.lit_gpt.rmsnorm import FusedRMSNorm
            return FusedRMSNorm
